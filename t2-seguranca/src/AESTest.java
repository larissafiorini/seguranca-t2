...
class AESTest {
    ...
    @Test
    void tarefa1() {
        System.out.println("\nTarefa 1: Decifrar com modo de operacao CBC");
        try {
    ...
    @Test
    void tarefa2() {
        System.out.println("\nTarefa 2: Decifrar com modo de operacao CBC");
        try {
            String key = "140b41b22a29beb4061bda66b6747e14";
    ...
    @Test
    void tarefa3() {
        System.out.println("\nTarefa 3: Decifrar com modo de operacao CTR");
        try {
    ...
    @Test
    void tarefa4() {
        System.out.println("\nTarefa 4: Decifrar com modo de operacao CTR");
        try {
            String key ="36f18357be4dbd77f050515c73fcf9f2";
    ...
    @Test
    void tarefa5() {
        System.out.println("\nTarefa 5: Cifrar com modo de operacao CTR");
        try {
            String key ="36f18357be4dbd77f050515c73fcf9f2";
            ...
            // Decifra de volta para mensagem texto claro inicial
    ...
    @Test
    void tarefa6() {
        System.out.println("\nTarefa 6: Cifrar com modo de operacao CBC");
        try {
            String key ="140b41b22a29beb4061bda66b6747e14";
